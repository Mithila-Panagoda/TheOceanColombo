...
urlpatterns = [
    ...
    url(r'^complaintReply/', views.complaintReply),
    url(r'^complaint3', views.complaintTypingLod),
    url(r'^complaintTyping/', views.complaintTyping),
    url(r'^complaint4/', views.complaintCheckReplyLod),
    url(r'^complaintCheckReply/', views.complaintCheckReply),
    url(r'^complaint5/', views.complaintUpdateReplyLod),
    url(r'^complaintUpdateReply/', views.complaintUpdateReply),
    ...
    url(r'^UpdateExpense/', views.updateExpense),
    url(r'^Expenses7/', views.ledgersLod),
    url(r'^ledgers/', views.ledgers),
    url(r'^Expenses8/', views.ledgersView),
    url(r'^Expenses9/', views.reports9Lod),
    url(r'^reports9/', views.reports9),
    ...
    url(r'^addmeal/', views.addmeal),
    url(r'^loadaddbeverage/',views.loadaddbeverage),
