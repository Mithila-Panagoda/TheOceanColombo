...
urlpatterns = [
    ...
    url(r'^updatebeverage/', views.updatebeverage),
    url(r'^updateRoomDetails', views.dirUpdateRoomDetails),
    url(r'^selectRoom/', views.loadselectroom),
    url(r'^confirmBooking/', views.loadconfirmbooking),
    url(r'^addBooking/', views.confirmbooking),
    url(r'^cancelBooking/', views.cancelbooking),
    url(r'^updateBooking/', views.updatebooking),
    url(r'^bookingConfirmed/', views.loadbookingconfirmed)
